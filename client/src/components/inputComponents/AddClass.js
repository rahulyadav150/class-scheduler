    ...
    return <>
        <div className='addClass'>
            <form onSubmit={handleSubmit} >
                ...
                <input id='topic' name='topic' value={inputData.topic} onChange={handleChange}  required /><br />
                <label htmlFor='teacher'>Teacher's name</label>
                <select name='teacherName' value={inputData.teacher} id='teacher' onChange={handleChange} >
                    <option value ='none' selected hidden disabled >Select an Option
                    </option>
                    {teachers.map((teacher) => (
                ...
                <input type='text' id='ends_at' name='ends_at' value={inputData.ends_at} onChange={handleChange} placeholder='13:30:00' required/>
                <br />
                <div style = {{display:'flex',justifyContent:'center'}}>
                <button className = 'canclebtn' onClick = {()=>setShowAdd(false)}  >Cancel</button>
