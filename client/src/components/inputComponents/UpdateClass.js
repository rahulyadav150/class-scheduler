    ...
    return <>
        <div className='addClass'>
            <form onSubmit={handleSubmit} >
                ...
                <select name='teacherName' value={inputData.teacherName} id='teacher' onChange={handleChange} >
                ...
                <button className = 'canclebtn' onClick = {()=>setShowUpdate(false)}  >Cancel</button>
